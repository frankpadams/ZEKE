...
must(version.includes("version: '0.48.0.2'")&&version.includes("build: '2026.08.30.1'"),'current v0.48 runtime identity missing');
...
must(sw.includes('project-zeke-v0.48.0.2-2026.08.30.1')&&sw.includes('assets/desktop-v047.css'),'service-worker cache identity/runtime surface incomplete');
must(css.includes('.v47-icon-svg')&&!/(^|\})\s*svg\s*\{/m.test(css),'unbounded generic SVG rules are forbidden');
console.log(JSON.stringify({ok:true,runtime:'0.48.0.2',preserved_release:'0.47.0',carry_forward:'v0.45.1 + verified v0.46/v0.47 functionality'},null,2));
