...
must(/version: '0\.\d+\.\d+'/.test(version)&&/build: '2026\.08\.23\.\d+'/.test(version)&&version.includes("repositorySchema: 5"),'current longitudinal runtime identity/schema missing');
