...
must(/version: '0\.43\.\d+'/.test(version)&&/build: '2026\.08\.(16|17)\.\d+'/.test(version)&&version.includes("repositorySchema: 5"),'v0.43 longitudinal runtime identity/schema missing');
