...
const must=['00_AI_START_HERE.md','RELEASE_NOTES.md','DEVELOPMENT_MEMORY/PROJECT_STATE.json','ARCHITECTURE.md','DESIGN_AUTHORITY.md','CURRENT_RELEASE_SCOPE.md','DECISION_LOG.md','DEVELOPMENT_MEMORY/ITERATION_HISTORY.md','DEVELOPMENT_MEMORY/RELEASE_GATE.md'];
