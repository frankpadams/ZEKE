...
const releaseRoot=path.resolve(__dirname,'..');const dataRoot=process.env.ZEKE_TEST_DATA_ROOT;if(!dataRoot){console.log('SKIP: ZEKE_TEST_DATA_ROOT not provided; real-data idempotency requires external Project Zeke fixture.');process.exit(0);}
