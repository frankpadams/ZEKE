...
def contradictory_release_gate(d):
    p=d/'DEVELOPMENT_MEMORY/RELEASE_GATE.md'; p.write_text(p.read_text().replace('**Package verification complete for Sprint 5 release-candidate scope.**','**Pending final verification.**'))
