...
must(index.includes('ZEKE v0.40.5')&&index.includes('2026.08.06.5'),'current version/build missing from index');
...
must(version.includes("version: '0.40.5'")&&sw.includes('project-zeke-v0.40.5-2026.08.06.5'),'version/cache mismatch');
