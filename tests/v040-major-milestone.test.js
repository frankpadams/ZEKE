...
must((app.includes('dashboard-v46')||app.includes('dashboard-v3'))&&app.includes('dashboard-insights-panel')&&app.includes('weeklyPlanHTML')&&app.includes('truthfulRecentActivityHTML'),'current dashboard structure missing');
