const CACHE_NAME = 'project-zeke-v0.44.0-2026.08.18.0';
const RUNTIME = [
  './','./index.html','./manifest.webmanifest','./version.js','./zeke-config.js','./xlsx-bundle.js',
  './assets/styles.css','./assets/mobile-native.css','./assets/data-layer.js','./assets/parser.js','./assets/ai-router.js',
  './assets/workflow-engine.js','./assets/exercise-guides.js','./assets/knowledge-base.js',
  './assets/integrity-engine.js','./assets/longitudinal-schema.js','./assets/ingestion-engine.js','./assets/calendar-privacy.js','./assets/app.js','./assets/mobile-native.js','./assets/branding/zeke-mark-provisional.png'
];
