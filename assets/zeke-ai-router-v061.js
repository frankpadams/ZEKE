  ...
  function createPanel(){
    ...
    root.innerHTML=`<button class="zair-fab" title="AI Router status">AI</button>
      <section class="zair-panel zair-panel-v6" hidden>
        <div class="zair-head"><div><strong>ZEKE AI Router</strong><span>v0.6.1 · free-first routing</span></div><button class="zair-close" aria-label="Close">×</button></div>
        ...
        <div class="zair-body">
          ...
          <div class="zair-tab" data-pane="setup" hidden>
            <div class="zair-quickstart">
              <div><strong>Fast free setup</strong><span>Start with one of these. ZEKE's router can fall back between any providers you enable.</span></div>
