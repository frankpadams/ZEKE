(() => {
  ...
  const BUILD = window.ZEKE_BUILD || window.ZEKE_VERSION || { version: '0.48.0', build: '2026.08.25.1', label: 'ZEKE v0.48 Development Integrity + Interaction Repair' };
  const state = {
  ...
  function openBodyAreaView(part=''){
    ...
    $$('[data-edit-event]',$('#bodyAreaOverlay')).forEach(b=>b.onclick=()=>{const id=b.dataset.editEvent;close();openEditEvent(id)});
  }
  ...
  function navHTML() {
    const items=[['dashboard','home','Home'],['health','heart','Health'],['fitness','dumbbell','Fitness'],['calendar','calendar','Calendar'],['insights','compass','Discover'],['documents','file','Documents'],['questions','question','Questions']];
