...
### Durable corrections
- Current runtime identity remains v0.46.0 build 2026.08.24.1; governance revision advances to 2026.08.24.2.
...
- Release-gate language distinguishes runtime build 2026.08.24.1, governance revision 2026.08.24.2, package-local evidence, and still-outstanding environment verification.
