...
Read `00_AI_START_HERE.md`, `HANDOFF_BRIEF.md`, `RELEASE_NOTES_v0.26.1.md`, and `TEST_REPORT_v0.26.1.md`.

## Deploy

Replace the deployed ZEKE files with this folder while preserving intended values in `zeke-config.js`. Hard-refresh once and confirm **v0.26.1 · build 2026.07.22.2**.
